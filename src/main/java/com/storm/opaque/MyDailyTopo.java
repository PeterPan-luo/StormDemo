...
import com.storm.partition.MyDailyCommitterBolt;
...
public class MyDailyTopo {
	...
	public static void main(String[] args) {
		...
		TransactionalTopologyBuilder builder = new TransactionalTopologyBuilder("ttbId","spoutid",new MyOpaquePtTxSqout(),1);
